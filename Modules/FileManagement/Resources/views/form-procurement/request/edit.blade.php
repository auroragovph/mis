                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="requesting" class="form-control select2" required data-size="5" data-live-search="true">
                                    ...
                                    @foreach($employees as $employee)
                                        <option {{ select_helper($employee->id, $document->purchase_request->requesting_id) }} value="{{ $employee->id }}">{{ name_helper($employee) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="form-group">
                                ...
                                <select name="charging" class="form-control select2" required data-size="5" data-live-search="true">
                                    <option value="" selected hidden></option>
                                    @foreach($divisions as $division)
                                        <option {{ select_helper($division->id, $document->purchase_request->charging_id) }} value="{{ $division->id }}">{{ office_helper($division) }}</option>
