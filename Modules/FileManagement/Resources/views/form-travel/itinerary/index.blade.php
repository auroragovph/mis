            ...
            <div class="card-header">
                ...
                @can(['fms.create'])
                    <div class="card-tools">
                        <a href="{{ route('fms.travel.itinerary.create') }}" class="btn btn-sm bg-gradient-primary"><i class="fas fa-plus"></i> Create New Itinerary</a>
                    </div>
                @endcan
            </div>
            <div class="card-body">
...
<script>
    $(function () {
      $("#dataTables").DataTable({
        processing: true,
        ajax: "{{ route('fms.travel.itinerary.index') }}",
        columns: [
