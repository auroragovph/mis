            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label>Payee</label>
                        <input value="{{ $cafoa->number }}" type="text" class="form-control" name="payee" required/>
                    </div>
                </div>
                <!--end::Group-->
                <!--begin::Group-->
                    ...
                    <div class="form-group">
                        ...
                        <select name="requesting" class="form-control select2" required>
                            @foreach($employees->where('division_id', auth()->user()->employee->division_id) as $employee)
                                <option value=""></option>
                                <option {{ sh($employee->id, $cafoa->requesting_id) }} value="{{ $employee->id }}">{{ name_helper($employee->name) }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div data-repeater-list="" class="col-lg-12">
                        ...
                        <div data-repeater-item="" class="form-group row align-items-center">
                            <div class="col-md-2">
                                ...
                                <input type="text" name="function" class="form-control" value="{{ $list['function'] ?? '' }}" />
                                <div class="d-md-none mb-2"></div>
                            </div>
                            <div class="col-md-3">
                                <label>Allotment Class:</label>
                                <input type="text" name="allotment" class="form-control" value="{{ $list['allotment'] ?? '' }}"/>
                                <div class="d-md-none mb-2"></div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="budget" class="form-control select2" required>
                            @foreach($employees->where('division_id', config('constants.office.BUDGET')) as $employee)
                                <option value=""></option>
                                <option {{ sh($employee->id, $cafoa->budget_id) }} value="{{ $employee->id }}">{{ name_helper($employee->name) }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="treasury" class="form-control select2" required>
                            @foreach($employees->where('division_id', config('constants.office.PTO')) as $employee)
                                <option value=""></option>
                                <option {{ sh($employee->id, $cafoa->treasury_id) }} value="{{ $employee->id }}">{{ name_helper($employee->name) }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="accountant" class="form-control select2" required>
                            @foreach($employees->where('division_id', config('constants.office.ACCOUNTING')) as $employee)
                                <option value=""></option>
                                <option {{ sh($employee->id, $cafoa->accountant_id) }} value="{{ $employee->id }}">{{ name_helper($employee->name) }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
