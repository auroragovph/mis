...
<div class="card card-custom gutter-b" id="card-box" data-card="true" >
   ...
   <div class="card-header py-3">
    ...
    <!--begin::Body-->
    <div class="card-body">
        <form class="form" id="kt_form" method="POST" action="{{ route('fms.procurement.cafoa.store', $document->id) }}">
            @csrf
                ...
                <div class="form-group row">
                    <div data-repeater-list="lists" class="col-lg-12">
                        <div data-repeater-item="" class="form-group row align-items-center">
                            ...
                            <div class="col-md-3">
                                <label>Amount:</label>
                                <input type="number" step="0.01" name="amount" class="form-control" value="{{ $amount ?? 0 }}" />
                                <div class="d-md-none mb-2"></div>
                            </div>
