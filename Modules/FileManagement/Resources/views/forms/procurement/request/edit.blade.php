...
<x-ui.card title="Purchase Request Edit Form">
    <form class="form" id="kt_form" method="POST" action="{{ route('fms.procurement.request.update', $pr->id) }}">
        ...
        <div class="row">
            ...
            <!--begin::Group-->
            <div class="col-md-12">
                <x-ui.form.text-area label="Purpose" name="purpose" :value="$pr->purpose" required />
            </div>
            <!--end::Group-->
        </div>
            ...
            <div class="form-group row">
                <div data-repeater-list="lists" class="col-lg-12">
                    ...
                    <div data-repeater-item="" class="form-group row align-items-center">
                        <div class="col-md-3">
                            <x-ui.form.input label="Stock Number:" :value="$list['stock']" type="text" name="stock" />
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <x-ui.form.input label="Quantity:" type="number" :value="$list['quantity']" name="quantity" min="0" />
                        </div>

                        <div class="col-md-3">
                            <x-ui.form.input label="Item Cost:" type="number" :value="$list['amount']" name="amount" min="0" step="0.01" />
                        </div>

                        <div class="col-md-12">
                            <x-ui.form.text-area label="Item Description" :value="$list['description']" name="description" required />
                        </div>
