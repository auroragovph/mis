<div class="collapse navbar-collapse order-3" id="navbarCollapse">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a href="{{ route('fms.dashboard') }}" class="nav-link">Dashboard</a>
      </li>

      <li class="nav-item">
        <a href="{{ route('fms.documents.index') }}" class="nav-link">Documents</a>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
          <li><a href="{{ route('fms.documents.attach.index') }}" class="dropdown-item">Document Attach</a></li>
          <li><a href="{{ route('fms.documents.rr.index') }}" class="dropdown-item">Receive / Release</a></li>
          <li><a href="{{ route('fms.documents.activate') }}" class="dropdown-item">Activation</a></li>
