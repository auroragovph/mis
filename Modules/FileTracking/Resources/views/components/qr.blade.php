    ...
    <div class="card card-default">
        <div class="card-body pt-15">
            ...
            <div class="text-center mb-10">
                <img width="60%" height="60%" src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(500)->merge('/public/images/logo-sm.png', .3)->errorCorrection('H')->generate($document->series)) !!} ">
                <span class="d-block mt-2">{{ $document->seriesFull }}</span>
