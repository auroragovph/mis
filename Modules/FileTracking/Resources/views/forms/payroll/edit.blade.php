...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item"><a href="{{ route('fts.payroll.index') }}">Payroll</a></li>
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-default">
            ...
            <div class="card-body">
                <form id="form-create" action="{{ route('fts.payroll.update', $document->id) }}" method="POST">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input value="{{ $document->payroll->name }}" type="text" name="name" class="form-control" required>
                          </div>
                      </div>
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input value="{{ $document->payroll->amount }}" name="amount" type="number" step="0.01" class="form-control" required>
                          </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                          <div class="form-group">
                              ...
                              <textarea name="particulars" cols="30" rows="2" class="form-control" required>{{ $document->payroll->particulars }}</textarea>
                          </div>
                      </div>
                    </div>
