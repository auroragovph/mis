...
<div class="card card-custom gutter-b" id="card-box" data-card="true" >
   ...
   <div class="card-header py-3">
        <div class="card-title align-items-start flex-column">
            <h3 class="card-label font-weight-bolder text-dark">PR Form</h3>
    ...
    <!--begin::Body-->
    <div class="card-body">
        <form id="kt_form" action="{{ route('fts.pr.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="number" step="0.01" required class="form-control" name="amount">
                  </div>
                </div>
