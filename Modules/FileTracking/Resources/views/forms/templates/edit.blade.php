...
<div class="card card-custom gutter-b" id="card-box" data-card="true" >
   ...
   <div class="card-header py-3">
        <div class="card-title align-items-start flex-column">
            <h3 class="card-label font-weight-bolder text-dark">Update Form</h3>
    ...
    <!--begin::Body-->
    <div class="card-body">
        <form id="kt_form" action="{{ route('fts.doc.update', $doc->id) }}" method="POST">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" disabled value="{{ $doc->document->seriesFull }}">
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <select name="division" class="form-control select2" required style="width: 100%">
                      ...
                      @foreach($divisions as $division)
                        <option {{ sh($division->id, $doc->document->division_id) }} value="{{ $division->id }}">{{ office_helper($division) }}</option>
                      @endforeach
                  </select>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="particulars" cols="30" rows="3" class="form-control">{{ $doc->particulars }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select name="liaison" class="form-control select2" required style="width: 100%">
                      ...
                      @foreach($liaisons as $liaison)
                        <option {{ sh($liaison->id, $doc->document->liaison_id) }} value="{{ $liaison->id }}">{{ name_helper($liaison->name) }}</option>
                      @endforeach
                  </select>
                </div>
              </div>
