<ul class="nav flex-column nav-pills">
    ...
    <li class="nav-item mb-2">
        <a class="nav-link active" id="informationTab-tab" data-toggle="tab" href="#informationTab">
            <span class="nav-icon">
    ...
    <li class="nav-item mb-2">
        <a class="nav-link" id="actlogsTab-tab" data-toggle="tab" href="#actlogsTab" aria-controls="actlogs">
            <span class="nav-icon">
                <i class="fal fa-sliders-h"></i>
            </span>
