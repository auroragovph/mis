...
<div class="card card-custom gutter-b tab-pane fade" id="credentialsTab" role="tabpanel" aria-labelledby="credentialsTab-tab">
    <!--begin::Header-->
    ...
    <!--begin::Body-->
    <div class="card-body">
        <form class="form" id="kt_form_credentials" method="POST" action="{{ route('hrm.employee.update', $employee->id) }}">
            @csrf
