<div class="d-none d-lg-block col-lg-3">
    <ul class="nav nav-pills nav-vertical">
        ...
        <li class="nav-item">
            <a href="#menu-base" class="nav-link" data-bs-toggle="collapse"
                aria-expanded="false">
                Getting started
        ...
        <li class="nav-item">
            <a href="#menu-content" class="nav-link" data-bs-toggle="collapse"
                aria-expanded="false">
                Content
                <span class="nav-link-toggle"></span>
            </a>
        ...
        <li class="nav-item">
            <a href="#menu-layout" class="nav-link" data-bs-toggle="collapse"
                aria-expanded="false">
                Layout
                <span class="nav-link-toggle"></span>
            </a>
        ...
        <li class="nav-item">
            <a href="#menu-forms" class="nav-link" data-bs-toggle="collapse"
                aria-expanded="false">
                Form components
                <span class="nav-link-toggle"></span>
            </a>
        ...
        <li class="nav-item">
            <a href="#menu-components" class="nav-link" data-bs-toggle="collapse"
                aria-expanded="false">
                Components
                <span class="nav-link-toggle"></span>
            </a>
        ...
        <li class="nav-item">
            <a href="#menu-utils" class="nav-link" data-bs-toggle="collapse"
                aria-expanded="false">
                Utilities
                <span class="nav-link-toggle"></span>
            </a>
        ...
        <li class="nav-item">
            <a href="#menu-plugins" class="nav-link" data-bs-toggle="collapse"
                aria-expanded="false">
                Plugins
                <span class="nav-link-toggle"></span>
            </a>
