...
/***/ "./Modules/FileTracking/Resources/assets/js/form-dv-create.js":
/*!********************************************************************!*\
  !*** ./Modules/FileTracking/Resources/assets/js/form-dv-create.js ***!
  \********************************************************************/
...
$(function () {
  ...
  $("#form-search").submit(function (e) {
    ...
    dt.columns(3).search($('input[name="search-payee"]').val());
    dt.columns(4).search($('input[name="search-amount"]').val());
    dt.columns(5).search($('input[name="search-particulars"]').val());
    dt.columns(6).search($('input[name="search-code"]').val());
    dt.columns(7).search($('input[name="search-accountable"]').val());
    dt.draw();
...
/***/ 13:
/*!**************************************************************************!*\
  !*** multi ./Modules/FileTracking/Resources/assets/js/form-dv-create.js ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/xijeixhan/Desktop/mis_dev/Modules/FileTracking/Resources/assets/js/form-dv-create.js */"./Modules/FileTracking/Resources/assets/js/form-dv-create.js");
