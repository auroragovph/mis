				...
				<div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #90e0ef; ">
					...
					<div class="d-flex flex-column-auto flex-column pt-lg-10 pt-15">
						...
						<a href="#" class="login-logo text-center pt-lg-25 pb-10">
							<img src="{{ asset('media/logos/logo-vertical.png') }}" class="max-h-150px" alt="" />
						</a>
						<!--end::Aside header-->
						<!--begin::Aside Title-->
						<h3 class="font-weight-bolder text-center font-size-h4 text-dark-50">Management Information System for
						<br />Provincial Government of Aurora</h3>

						<!--end::Aside Title-->
					</div>
					<!--end::Aside Top-->
					<!--begin::Aside Bottom-->
					<div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center" style="background-position-y: calc(100% + 1rem); background-image: url({{ asset('media/svg/illustrations/login-visual-5.svg') }})"></div>
					<!--end::Aside Bottom-->
				</div>
				<!--begin::Aside-->
				<!--begin::Content-->
