    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <li class="nav-item">
        <a href="{{ route('sys.office.index') }}" class="nav-link">
          <i class="nav-icon fad fa-building"></i> <p>Office</p>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a href="{{ route('sys.user.index') }}" class="nav-link">
          <i class="nav-icon fad fa-user-alt"></i> <p>Users</p>
        </a>
      </li>

      <li class="nav-item">
        <a href="{{ route('sys.user.acl.index') }}" class="nav-link">
          <i class="nav-icon fad fa-shield"></i> <p>Access Control List</p>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a href="javascript:void(0)" class="nav-link">
          <i class="nav-icon fas fa-calendar-day"></i> <p>Scheduler</p>
        </a>
      </li>
