...
<head>
  ...
  <title> 
    @if(Illuminate\Support\Facades\App::environment('local'))
      ___DEVELOPMENT___
    @endif
      Aurora MIS | {{ $module_title ?? '' }}
  </title>

  <!-- Font Awesome Icons -->
  {{-- <link rel="stylesheet" href="{{ asset('plugins/fontawesome-free/css/all.min.css') }}"> --}}
  <link rel="stylesheet" href="{{ asset('plugins/fontawesome-free/css/fontawesome.min.css') }}">
  <link rel="stylesheet" href="{{ asset('plugins/fontawesome-free/css/light.min.css') }}">
  <!-- overlayScrollbars -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">{{ $module_title ?? '' }}</a>
      </li>
  ...
  <aside class="main-sidebar elevation-1 sidebar-light-olive">
    <!-- Brand Logo -->
